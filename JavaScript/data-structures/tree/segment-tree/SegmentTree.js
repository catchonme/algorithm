import isPowerOfTwo from '../../../math/is-power-of-two/isPowerOfTwo'
...
export default class SegmentTree {
    ...
    buildTreeRecursively(leftInputIndex, rightInputIndex, position) {
        ...
        const middleIndedx = Math.floor((leftInputIndex + rightInputIndex) / 2);
        this.buildTreeRecursively(leftInputIndex, middleIndedx, this.getLeftChildIndex(position));
